/*
StageWrap: Based on Free (MPL) {jAction Lib} && {jAction FrameWork}
...
Package:		jActionEditor/app/core/stage/StageWrap.js
Class:			public static class StageWrap
Inheritance:	StageWrap > Sprite > DisplayObjectContainer > InteractiveObject > DisplayObject > EventDispatcher >  _Object
Version:
0.0.2 - Last update 2024-10-21 -> Added EditorEvent event firing
0.0.1 - Last update 2024-05-08 -> First version

Nota: Cambiar el nombre de la clase de StageWrap a StageWrap
*/
class StageWrap extends Sprite{
	...
	/*private var*/ #_onMoveSelectedItems	/*:Function*/	= null;
	...
	*----------------------------------------------------------------------------------------------------------------------------------*/
	...
	/*public function*/ get selectedItems()/*:DisplayObject*/{return this.#_selectedItem;}

	/**-----------------------------------------------------------------------------------------------------------------------------------
	*
	*	onSelectedItems public callback function
	*	Notifies the property inspector of the selected object to view its properties
	*	At the moment the PropertyInspector.js class is the one that assigns a callback function to this property in order to listen to which 
	*	components are selected, perhaps the system will change in the future, to listen to custom events launched by this class.
	*
	*----------------------------------------------------------------------------------------------------------------------------------*/

	/*public function*/ set onSelectedItems(callback/*:Function*/)/*:Number*/{this.#_onSelectedItems = callback;}
	/*public function*/ get onSelectedItems()/*:Function*/{return this.#_onSelectedItems;}
	...
	*----------------------------------------------------------------------------------------------------------------------------------*/
	...
	/*public function*/ set onMoveSelectedItems(callback/*:Function*/)/*:Number*/{this.#_onMoveSelectedItems = callback;}
	/*public function*/ get onMoveSelectedItems()/*:Function*/{return this.#_onMoveSelectedItems;}
	...
	*----------------------------------------------------------------------------------------------------------------------------------*/
	...
	/*public function*/ get virtualStage()/*:Number*/{return this.#_stage_spt;}
	...
	*----------------------------------------------------------------------------------------------------------------------------------*/
	...
	/*public function*/ set rules(value/*:Boolean*/)/*:void*/ {
	...
	/*public function*/ get rules()/*:Boolean*/ { return this.#_rules; }
	...
	*----------------------------------------------------------------------------------------------------------------------------------*/
    ...
    /*public function*/ remove(value/*:DisplayObject*/)/*:void*/{
		this.#_stage_spt.removeChild(value);
	}
	...
	*	que provocaban comportamientos no deseados, como por ejemplo checkBox que cada vez que se seleccionaba para arrastrar cambiaba su
	*	estado selected, para solucionar esto habría que establecer mouseEnabled a false para el propio componente, pero entonces queda
	...
	/*private function*/ #MouseMoveHandler(e/*:Event*/ = null)/*:void*/ {
		...
		if (this.toolHand) {
			...
			if (this.#_selectedItem !== null) {
				...
				//if (this.#_onMoveSelectedItems) {
					//this.#_onMoveSelectedItems({ x: this.#_selectedItem.x, y: this.#_selectedItem.y });

					const eic /*:EditorEvent*/ = new EditorEvent(EditorEvent.EDITOR_ITEMS_CHANGE, true, false, null, [this.#_selectedItem]);
					
					this.parent.parent.dispatchEvent(EditorEvent.EDITOR_ITEMS_CHANGE, eic);
				//}
