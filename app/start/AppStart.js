class AppStart {
    ...
    /*private function*/ #OnSkinChange(e = null)/*void*/ {
		...
		const iPath /*:String*/ = G.rootPath+"assets/icons/";
		...
		library.addItem("bep_wav",  G.rootPath+"assets/sounds/beep.wav");
	...
	*/
    ...
    /*private function*/ #OnLibComplete(e/*:Event*/)/*:void*/{ 
		...
		if(this.#_cacheVersion == config.version){
			...
			stage.setFullBackGround(G.rootPath+'assets/default/@bg'+Math.floor(Math.random() * 13)+'.jpg');
		}
	}
    ...
    /*public function*/ #LoadForm(path/*:String*/,params/*:Array*/,onClose/*:Function*/)/*:void*/{
		G.FLoader.load(stage, 'app/forms/'+path,this.#OnLoadInitForm.bind(this) ,onClose,params);
	}	
