...
class MainMenu extends Form {
   ...
   //*private var*/ #_outBind      /*:Function*/      = this.#OnOut.bind(this);
	...
	/*private var*/ #_defWorkSpace /*:Array<String>*/ = [{path:"forms/windows/StageEditor.js", target:this.controls              , f:'StageEditor',x:-1  , y:10 },
														 {path:"forms/windows/Elements.js"   , target:this.#_leftBox_frm.controls, f:'Elements'   ,x:0   , y:0  },
														 {path:"forms/windows/Tools.js"      , target:this.#_leftBox_frm.controls, f:'Tools'      ,x:175 , y:0  },
														 {path:"forms/windows/SetLayout.js"  , target:this.controls              , f:'SetLayout'  ,x:300 , y:10 },
														 {path:"forms/windows/GetLayout.js"  , target:this.controls              , f:'GetLayout'  ,x:300 , y:400},
														 {path:"forms/windows/Properties.js" , target:this.controls              , f:'Properties' ,x:1750, y:10 }];
	...
	/*public function*/ MainMenu(params/*:Array*/=null)/*:void*/{
		...
		this.#_WIN.setButton("Properties", "pro", this.#_evtBind , '', null, this.#_defWorkSpace[5]);
